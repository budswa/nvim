...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp", "cmp-rg", "cmp-buffer", "cmp-git", "cmp-copilot", "cmp-nvim-lua", "cmp-calc", "cmp-path", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.nvim', 'cmp-treesitter', 'cmp-nvim-lsp', 'cmp-rg', 'cmp-buffer', 'cmp-git', 'cmp-copilot', 'cmp-nvim-lua', 'cmp-calc', 'cmp-path', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'tabout.nvim', 'surround.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'lightspeed.nvim', 'gitsigns.nvim', 'nvim-treesitter-textobjects', 'gitlinker.nvim', 'nvim-autopairs', 'numb.nvim', 'nvim-hlslens', 'refactoring.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
