...
local no_errors, error_msg = pcall(function()
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'tabout.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'lightspeed.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'gitlinker.nvim', 'renamer.nvim', 'refactoring.nvim', 'presence.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au vimenter * ++once lua require("packer.load")({'packer.nvim'}, { event = "vimenter *" }, _G.packer_plugins)]])
	vim.cmd([[au VimEnter * ++once lua require("packer.load")({'github-nvim-theme'}, { event = "VimEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-copilot', 'cmp-calc', 'cmp-buffer', 'better-escape.nvim', 'LuaSnip', 'nvim-cmp', 'cmp_luasnip', 'cmp-nvim-lsp', 'cmp-rg'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
