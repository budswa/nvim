...
_G.packer_plugins = {
  ...
  ["format-installer.nvim"] = {
    loaded = true,
    path = "/home/m2/.local/share/nvim/site/pack/packer/start/format-installer.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-calc", "cmp-cmdline", "cmp_luasnip", "cmp-git", "cmp-nvim-lua", "cmp-path", "cmp-treesitter", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp", "cmp-copilot" },
    loaded = true,
    only_config = true
  },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/m2/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["themer.lua"] = {
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19plugins.themer\frequire\0" },
    loaded = true,
    path = "/home/m2/.local/share/nvim/site/pack/packer/start/themer.lua",
...
try_loadstring("\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19plugins.themer\frequire\0", "config", "themer.lua")
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-textobj-user', 'nvim-spectre'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'presence.nvim', 'numb.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'gitlinker.nvim', 'gitsigns.nvim', 'nvim-lastplace', 'nvim-hlslens', 'nvim-treesitter-textobjects', 'lightspeed.nvim', 'refactoring.nvim', 'nvim-autopairs', 'surround.nvim', 'Comment.nvim', 'tabout.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'toggleterm.nvim', 'which-key.nvim', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-rg', 'cmp-buffer', 'cmp-calc', 'cmp_luasnip', 'cmp-git', 'cmp-nvim-lua', 'cmp-path', 'cmp-treesitter', 'better-escape.nvim', 'LuaSnip', 'cmp-nvim-lsp', 'cmp-copilot'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CmdLineEnter * ++once lua require("packer.load")({'cmp-cmdline', 'cmp-nvim-lsp-signature-help'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]]
