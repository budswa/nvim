...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-calc", "cmp-cmdline", "cmp-copilot", "cmp-git", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp-rg" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'tabout.nvim', 'numb.nvim', 'refactoring.nvim', 'Comment.nvim', 'lightspeed.nvim', 'nvim-treesitter-textobjects', 'nvim-lastplace', 'nvim-autopairs', 'gitlinker.nvim', 'surround.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'nvim-hlslens'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'cmp-buffer', 'cmp-calc', 'cmp-copilot', 'cmp-git', 'cmp-nvim-lsp', 'cmp-nvim-lua', 'cmp-path', 'cmp-treesitter', 'better-escape.nvim', 'LuaSnip', 'cmp-rg'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
