...
local no_errors, error_msg = pcall(function()
	...
	vim.cmd([[au VimEnter * ++once lua require("packer.load")({'github-nvim-theme', 'alpha-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]])
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'nvim-lastplace', 'gitlinker.nvim', 'tabout.nvim', 'indent-blankline.nvim', 'presence.nvim', 'nvim-treesitter', 'lightspeed.nvim', 'renamer.nvim', 'refactoring.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-calc', 'cmp-buffer', 'better-escape.nvim', 'LuaSnip', 'nvim-cmp', 'cmp_luasnip', 'cmp-copilot', 'cmp-rg'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
