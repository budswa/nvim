...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		['rose-pine'] = {
			config = {
				"\27LJ\2\nn\0\0\3\0\5\0\t6\0\0\0009\0\1\0+\1\2\0=\1\2\0006\0\0\0009\0\3\0'\2\4\0B\0\2\1K\0\1\0\26colorscheme rose-pine\bcmd'rose_pine_disable_float_background\6g\bvim\0",
			},
			loaded = false,
			needs_bufread = false,
			only_cond = false,
			path = '/home/m2/.local/share/nvim/site/pack/packer/opt/rose-pine',
		...
		['vim-table-mode'] = {
			loaded = true,
			path = '/home/m2/.local/share/nvim/site/pack/packer/start/vim-table-mode',
	...
	vim.cmd([[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'cmp-rg', 'LuaSnip', 'better-escape.nvim', 'cmp-buffer', 'cmp-copilot', 'cmp-nvim-lsp', 'cmp-nvim-lua', 'cmp-path', 'cmp-treesitter', 'cmp_luasnip', 'cmp-calc'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-hlslens', 'Comment.nvim', 'nvim-treesitter', 'nvim-lastplace', 'presence.nvim', 'refactoring.nvim', 'gitlinker.nvim', 'renamer.nvim', 'gitsigns.nvim', 'indent-blankline.nvim', 'lightspeed.nvim', 'surround.nvim', 'tabout.nvim', 'nvim-treesitter-textobjects', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au BufNewFile * ++once lua require("packer.load")({'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]])
	vim.cmd([[au VimEnter * ++once lua require("packer.load")({'rose-pine'}, { event = "VimEnter *" }, _G.packer_plugins)]])
