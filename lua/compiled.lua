...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp-buffer", "cmp-calc", "cmp-git", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp-copilot", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'cmp-rg', 'cmp-treesitter', 'cmp-buffer', 'cmp-calc', 'cmp-git', 'cmp-nvim-lua', 'cmp-path', 'cmp-nvim-lsp', 'cmp-copilot', 'better-escape.nvim', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'lightspeed.nvim', 'gitsigns.nvim', 'nvim-hlslens', 'gitlinker.nvim', 'numb.nvim', 'nvim-colorizer.lua', 'nvim-lastplace', 'refactoring.nvim', 'tabout.nvim', 'surround.nvim', 'presence.nvim', 'Comment.nvim', 'nvim-treesitter-textobjects'}, { event = "BufRead *" }, _G.packer_plugins)]]
