...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-copilot", "cmp-git", "cmp-rg", "cmp-nvim-lsp-signature-help", "cmp_luasnip", "cmp-nvim-lua", "cmp-path", "cmp-treesitter", "cmp-calc", "cmp-nvim-lsp" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'DAPInstall.nvim', 'nvim-dap'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitlinker.nvim', 'gitsigns.nvim', 'refactoring.nvim', 'lightspeed.nvim', 'tabout.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'nvim-hlslens', 'numb.nvim', 'nvim-lastplace', 'nvim-treesitter-textobjects', 'surround.nvim', 'todo-comments.nvim', 'nvim-autopairs'}, { event = "BufRead *" }, _G.packer_plugins)]]
