...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp_luasnip", "cmp-nvim-lua", "cmp-treesitter", "cmp-cmdline", "cmp-path", "cmp-copilot", "cmp-calc", "cmp-git", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lsp-signature-help" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'nvim-lspconfig', 'DAPInstall.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter-textobjects', 'gitlinker.nvim', 'nvim-hlslens', 'nvim-autopairs', 'nvim-colorizer.lua', 'todo-comments.nvim', 'tabout.nvim', 'refactoring.nvim', 'lightspeed.nvim', 'numb.nvim', 'surround.nvim', 'Comment.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-rg', 'cmp_luasnip', 'cmp-nvim-lua', 'cmp-treesitter', 'cmp-path', 'cmp-copilot', 'cmp-calc', 'cmp-git', 'cmp-nvim-lsp', 'cmp-buffer', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
