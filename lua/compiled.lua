...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-git", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-copilot", "LuaSnip", "cmp_luasnip", "cmp-calc", "cmp-path", "cmp-rg" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter-textobjects', 'Comment.nvim', 'numb.nvim', 'nvim-lastplace', 'nvim-hlslens', 'refactoring.nvim', 'todo-comments.nvim', 'lightspeed.nvim', 'gitsigns.nvim', 'gitlinker.nvim', 'tabout.nvim', 'surround.nvim', 'nvim-autopairs'}, { event = "BufRead *" }, _G.packer_plugins)]]
