...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-copilot", "cmp-git", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp-treesitter", "cmp_luasnip", "cmp-rg", "cmp-buffer", "cmp-calc", "cmp-cmdline" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'nvim-treesitter-textobjects', 'gitlinker.nvim', 'refactoring.nvim', 'gitsigns.nvim', 'nvim-autopairs', 'surround.nvim', 'tabout.nvim', 'lightspeed.nvim', 'Comment.nvim', 'todo-comments.nvim', 'nvim-hlslens', 'nvim-lastplace', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
