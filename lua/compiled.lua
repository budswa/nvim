...
local no_errors, error_msg = pcall(function()
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'lightspeed.nvim', 'renamer.nvim', 'refactoring.nvim', 'gitsigns.nvim', 'vim-table-mode', 'nvim-colorizer.lua', 'nvim-treesitter', 'indent-blankline.nvim', 'gitlinker.nvim', 'presence.nvim', 'nvim-hlslens', 'todo-comments.nvim', 'Comment.nvim', 'nvim-treesitter-textobjects', 'nvim-lastplace', 'tabout.nvim', 'surround.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp-rg', 'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-calc', 'cmp-buffer', 'better-escape.nvim', 'nvim-cmp', 'LuaSnip', 'cmp-copilot', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
