...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp_luasnip", "cmp-nvim-lua", "cmp-git", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "LuaSnip", "cmp-nvim-lsp", "cmp-calc", "cmp-path", "cmp-copilot", "cmp-buffer", "cmp-treesitter" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'gitlinker.nvim', 'todo-comments.nvim', 'nvim-autopairs', 'nvim-hlslens', 'tabout.nvim', 'surround.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'numb.nvim', 'nvim-treesitter-textobjects', 'refactoring.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
