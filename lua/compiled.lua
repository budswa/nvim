...
local no_errors, error_msg = pcall(function()
	...
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp-rg', 'cmp-git', 'better-escape.nvim', 'cmp-copilot', 'cmp-nvim-lua', 'LuaSnip', 'cmp_luasnip', 'cmp-buffer', 'cmp-calc', 'cmp-treesitter', 'cmp-nvim-lsp', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au BufNewFile * ++once lua require("packer.load")({'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]])
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'tabout.nvim', 'surround.nvim', 'refactoring.nvim', 'nvim-treesitter-textobjects', 'presence.nvim', 'lightspeed.nvim', 'numb.nvim', 'gitlinker.nvim', 'gitsigns.nvim', 'nvim-hlslens', 'nvim-lastplace', 'nvim-colorizer.lua', 'Comment.nvim', 'nvim-treesitter', 'nvim-autopairs'}, { event = "BufRead *" }, _G.packer_plugins)]])
