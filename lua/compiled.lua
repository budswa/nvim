...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-nvim-lua", "cmp-calc", "cmp-treesitter", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "cmp_luasnip", "cmp-copilot", "cmp-git", "cmp-path", "cmp-buffer", "cmp-nvim-lsp" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'tabout.nvim', 'nvim-treesitter-textobjects', 'refactoring.nvim', 'Comment.nvim', 'gitsigns.nvim', 'gitlinker.nvim', 'nvim-lastplace', 'lightspeed.nvim', 'nvim-colorizer.lua', 'surround.nvim', 'nvim-hlslens', 'nvim-autopairs', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
