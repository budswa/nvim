...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-treesitter", "cmp-cmdline", "cmp-nvim-lua", "cmp-copilot", "cmp-calc", "cmp-buffer", "cmp-git", "cmp-nvim-lsp", "cmp_luasnip", "cmp-rg" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-copilot', 'cmp-calc', 'cmp-buffer', 'cmp-git', 'cmp-nvim-lsp', 'cmp_luasnip', 'cmp-rg', 'LuaSnip', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-spectre', 'vim-textobj-user'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-autopairs', 'numb.nvim', 'tabout.nvim', 'surround.nvim', 'gitsigns.nvim', 'refactoring.nvim', 'nvim-treesitter-textobjects', 'lightspeed.nvim', 'nvim-lastplace', 'Comment.nvim', 'nvim-hlslens', 'gitlinker.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
