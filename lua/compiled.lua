...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-ts-autotag" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'nvim-cmp', 'cmp-rg', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-copilot', 'cmp-calc', 'cmp-buffer', 'better-escape.nvim', 'LuaSnip', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-table-mode', 'gitsigns.nvim', 'gitlinker.nvim', 'nvim-colorizer.lua', 'nvim-lastplace', 'nvim-treesitter-textobjects', 'nvim-treesitter', 'tabout.nvim', 'surround.nvim', 'lightspeed.nvim', 'renamer.nvim', 'refactoring.nvim', 'presence.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'todo-comments.nvim', 'nvim-hlslens'}, { event = "BufRead *" }, _G.packer_plugins)]]
