...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-treesitter", "cmp-cmdline", "cmp-rg", "cmp_luasnip", "cmp-path", "cmp-copilot", "cmp-calc", "cmp-git", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lsp-signature-help" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'gitsigns.nvim', 'gitlinker.nvim', 'nvim-autopairs', 'nvim-hlslens', 'todo-comments.nvim', 'surround.nvim', 'tabout.nvim', 'Comment.nvim', 'numb.nvim', 'nvim-lastplace', 'refactoring.nvim', 'nvim-colorizer.lua', 'lightspeed.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-nvim-lua', 'cmp-treesitter', 'better-escape.nvim', 'cmp-rg', 'cmp_luasnip', 'cmp-path', 'cmp-copilot', 'cmp-calc', 'cmp-git', 'cmp-nvim-lsp', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
