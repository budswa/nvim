...
_G.packer_plugins = {
  ...
  ["heirline.nvim"] = {
    ...
    loaded = true,
    path = "/home/m2/.local/share/nvim/site/pack/packer/start/heirline.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-git", "cmp-nvim-lsp", "cmp-calc", "cmp-nvim-lua", "cmp-treesitter", "cmp-cmdline", "cmp-copilot", "cmp-buffer", "cmp_luasnip", "cmp-rg", "LuaSnip" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'DAPInstall.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'Comment.nvim', 'nvim-hlslens', 'lightspeed.nvim', 'todo-comments.nvim', 'nvim-treesitter-textobjects', 'gitlinker.nvim', 'nvim-autopairs', 'tabout.nvim', 'numb.nvim', 'surround.nvim', 'refactoring.nvim', 'gitsigns.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
