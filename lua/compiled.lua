...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		['stabilize.nvim'] = {
			...
			needs_bufread = false,
			only_cond = false,
			path = '/home/m2/.local/share/nvim/site/pack/packer/opt/stabilize.nvim',
	...
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'cmp-nvim-lua', 'cmp-path', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp-copilot', 'cmp-treesitter', 'cmp-rg', 'LuaSnip', 'better-escape.nvim', 'cmp-buffer', 'cmp-calc'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'presence.nvim', 'refactoring.nvim', 'stabilize.nvim', 'nvim-treesitter-textobjects', 'gitlinker.nvim', 'gitsigns.nvim', 'lightspeed.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'renamer.nvim', 'surround.nvim', 'nvim-hlslens', 'Comment.nvim', 'tabout.nvim', 'indent-blankline.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]])
