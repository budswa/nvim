...
local no_errors, error_msg = pcall(function()
	...
	vim.cmd(
		[[au BufEnter * ++once lua require("packer.load")({'nvim-spectre', 'vim-textobj-user'}, { event = "BufEnter *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-copilot', 'LuaSnip', 'cmp-rg', 'cmp-calc', 'better-escape.nvim', 'cmp_luasnip', 'cmp-buffer', 'cmp-git', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au BufNewFile * ++once lua require("packer.load")({'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'tabout.nvim', 'refactoring.nvim', 'lightspeed.nvim', 'nvim-treesitter-textobjects', 'nvim-lastplace', 'gitsigns.nvim', 'gitlinker.nvim', 'surround.nvim', 'nvim-autopairs', 'nvim-hlslens', 'Comment.nvim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'DAPInstall.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au CmdLineEnter * ++once lua require("packer.load")({'cmp-nvim-lsp-signature-help', 'cmp-cmdline'}, { event = "CmdLineEnter *" }, _G.packer_plugins)]]
	)
	vim.cmd(
		[[au BufWinEnter * ++once lua require("packer.load")({'toggleterm.nvim', 'which-key.nvim', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
	)
