...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-rg", "cmp-copilot", "cmp-calc", "cmp-cmdline", "cmp-git", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp_luasnip', 'cmp-rg', 'cmp-copilot', 'cmp-calc', 'cmp-git', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-buffer', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-treesitter-textobjects', 'nvim-autopairs', 'gitsigns.nvim', 'gitlinker.nvim', 'lightspeed.nvim', 'nvim-hlslens', 'nvim-colorizer.lua', 'surround.nvim', 'Comment.nvim', 'tabout.nvim', 'refactoring.nvim', 'todo-comments.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
