...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    config = { "\27LJ\2\n^\0\0\4\0\5\0\n6\0\0\0'\2\1\0B\0\2\0026\1\0\0'\3\2\0B\1\2\0029\1\3\0019\3\4\0B\1\2\1K\0\1\0\topts\nsetup\nalpha\26alpha.themes.startify\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lightspeed.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'gitlinker.nvim', 'renamer.nvim', 'refactoring.nvim', 'presence.nvim', 'nvim-lastplace', 'nvim-colorizer.lua', 'Comment.nvim', 'tabout.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'cmp-rg', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-buffer', 'better-escape.nvim', 'cmp-treesitter', 'cmp-calc', 'nvim-cmp', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
