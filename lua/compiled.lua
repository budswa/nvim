...
_G.packer_plugins = {
  ...
  ["iswap.nvim"] = {
    ...
    config = { "\27LJ\2\n0\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\21garden.ext.iswap\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["neovim-session-manager"] = {
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24garden.ext.sessions\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground", "nvim-ts-rainbow", "nvim-ts-autotag" },
  ...
  ["pretty-fold.nvim"] = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20garden.ext.fold\frequire\0" },
    loaded = true,
  ...
  ["zk-nvim"] = {
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18garden.ext.zk\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18garden.ext.zk\frequire\0", "config", "zk-nvim")
...
try_loadstring("\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24garden.ext.sessions\frequire\0", "config", "neovim-session-manager")
...
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20garden.ext.fold\frequire\0", "config", "pretty-fold.nvim")
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-nvim-lua', 'cmp-path', 'cmp-treesitter', 'cmp_luasnip', 'cmp-copilot', 'cmp-rg', 'better-escape.nvim', 'cmp-buffer', 'cmp-calc', 'LuaSnip', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-notify', 'github-nvim-theme'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-hlslens', 'surround.nvim', 'tabout.nvim', 'gitlinker.nvim', 'vim-table-mode', 'gitsigns.nvim', 'indent-blankline.nvim', 'lightspeed.nvim', 'nvim-lastplace', 'nvim-treesitter-textobjects', 'refactoring.nvim', 'presence.nvim', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
