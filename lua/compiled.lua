...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp_luasnip", "cmp-nvim-lsp-signature-help", "LuaSnip", "cmp-path", "cmp-git", "cmp-nvim-lsp", "cmp-calc", "cmp-nvim-lua", "cmp-treesitter", "cmp-cmdline", "cmp-copilot", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'nvim-lastplace', 'nvim-autopairs', 'Comment.nvim', 'tabout.nvim', 'nvim-hlslens', 'surround.nvim', 'refactoring.nvim', 'nvim-treesitter-textobjects', 'nvim-colorizer.lua', 'gitsigns.nvim', 'numb.nvim', 'lightspeed.nvim', 'gitlinker.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
