...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-cmdline", "cmp-calc", "cmp_luasnip", "LuaSnip", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-treesitter", "cmp-buffer", "cmp-rg", "cmp-git", "cmp-copilot" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'nvim-colorizer.lua', 'Comment.nvim', 'numb.nvim', 'nvim-treesitter-textobjects', 'nvim-lastplace', 'surround.nvim', 'lightspeed.nvim', 'refactoring.nvim', 'tabout.nvim', 'gitsigns.nvim', 'nvim-autopairs', 'gitlinker.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
