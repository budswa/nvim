...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		NrrwRgn = {
			loaded = true,
			path = '/home/m2/.local/share/nvim/site/pack/packer/start/NrrwRgn',
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'tabout.nvim', 'surround.nvim', 'nvim-treesitter-textobjects', 'renamer.nvim', 'refactoring.nvim', 'nvim-lastplace', 'presence.nvim', 'nvim-hlslens', 'vim-table-mode', 'nvim-colorizer.lua', 'Comment.nvim', 'gitlinker.nvim', 'lightspeed.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]])
	vim.cmd([[au InsertEnter * ++once lua require("packer.load")({'cmp-rg', 'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-copilot', 'cmp-calc', 'better-escape.nvim', 'LuaSnip', 'nvim-cmp', 'cmp_luasnip', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]])
