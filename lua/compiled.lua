...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "playground" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-lastplace', 'gitlinker.nvim', 'nvim-treesitter-textobjects', 'vim-table-mode', 'nvim-treesitter', 'nvim-colorizer.lua', 'todo-comments.nvim', 'Comment.nvim', 'tabout.nvim', 'surround.nvim', 'lightspeed.nvim', 'renamer.nvim', 'refactoring.nvim', 'presence.nvim', 'nvim-hlslens'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-copilot', 'cmp-calc', 'cmp-buffer', 'better-escape.nvim', 'LuaSnip', 'cmp-rg', 'nvim-cmp', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
