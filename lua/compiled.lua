...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'presence.nvim', 'gitsigns.nvim', 'gitlinker.nvim', 'Comment.nvim', 'nvim-lastplace', 'nvim-treesitter-textobjects', 'todo-comments.nvim', 'nvim-treesitter', 'tabout.nvim', 'indent-blankline.nvim', 'surround.nvim', 'nvim-hlslens', 'lightspeed.nvim', 'renamer.nvim', 'refactoring.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-treesitter', 'cmp-path', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-copilot', 'cmp-buffer', 'better-escape.nvim', 'LuaSnip', 'cmp_luasnip', 'cmp-rg', 'nvim-cmp', 'cmp-calc'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
