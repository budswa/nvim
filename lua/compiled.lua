...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp_luasnip", "cmp-rg", "cmp-buffer", "cmp-calc", "cmp-path", "cmp-cmdline", "cmp-copilot", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-autotag", "neogen", "playground" },
  ...
  ["tabby.nvim"] = {
    ...
    loaded = true,
    path = "/home/m2/.local/share/nvim/site/pack/packer/start/tabby.nvim",
...
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20plugins.tabline\frequire\0", "config", "tabby.nvim")
