...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "cmp-copilot", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-path", "cmp-rg", "cmp-git", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-calc", "cmp-treesitter" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-autopairs', 'lightspeed.nvim', 'refactoring.nvim', 'nvim-treesitter-textobjects', 'gitsigns.nvim', 'gitlinker.nvim', 'nvim-lastplace', 'nvim-hlslens', 'numb.nvim', 'nvim-colorizer.lua', 'surround.nvim', 'tabout.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
