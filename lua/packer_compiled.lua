...
_G.packer_plugins = {
  ...
  ["renamer.nvim"] = {
    ...
    loaded = true,
    path = "/home/m2/.local/share/nvim/site/pack/packer/start/renamer.nvim",
...
try_loadstring("\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23garden/ext/renamer\frequire\0", "config", "renamer.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'nvim-colorizer.lua', 'presence.nvim', 'refactoring.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
