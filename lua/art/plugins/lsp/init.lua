...
function lsp.on_attach(client, bufnr)
    ...
    map("n", "g0", function() vim.lsp.buf.document_symbol() end, {})
    ...
    if client.server_capabilities.formatProvider then vim.bo[bufnr].formatexpr = "v:lua.vim.lsp.formatexpr()" end
